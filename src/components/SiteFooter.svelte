    ...
    <div class="col-desk-12 col-tab-10 col-mob-4" header="Sergio Forés">
      <aside class="Bio grid">
        <div class="col-desk-2">
          <img src="img/avatar.jpg" class="BioAvatar" />
        </div>
        <div class="col-desk-5">
          <small class="BioExcerpt">
            Sergio es artista y diseñador front-end. Le apasiona vivir el proceso de la Creación y trata de aportar una mirada sintética y holística a partir de su proyecto TODH.
          </small>
        </div>
